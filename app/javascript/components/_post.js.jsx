...
class Post extends Component {
  ...
  render() {
    let title = this.state.editable ? <input minlength="5" maxlength="30" type='text' ref='title' defaultValue={this.props.post.title} /> : <h3>{this.props.post.title + " " + this.props.post.factorial} </h3>;
